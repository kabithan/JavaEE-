...
.mycheckbox{
  ...
  <body>  
    ...
    <div class="mysign">
         ...
         <form name="reg" id="regFrm" action="admin/register" method="post" onsubmit="">  
                <div class="col-lg-10">
                 <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;输入账号:</h4>
                ...
                <input type="checkbox" class="col-lg-1"  checked="checked" onclick="terms()"/>我同意无名协议
                </div>
               
        <div class="col-lg-10">
                    <button type="submit" class="btn btn-success col-lg-12" id="btn_reg" onclick="regPotentialUser()">注册</button>
        </div>
            </form>
        </div> 
       </div>
